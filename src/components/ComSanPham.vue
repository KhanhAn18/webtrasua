  ...
  <div class="container">
    <div class="filter-group">
        ...
        <select v-model="selectedCategory" class="form-select">
          ...
          <option value="TraTuoi">Trà tươi</option>
        </select>
      </div>
  ...
  <div class="menu-container">
    <div class="products-section">
      <div class="category-section" v-if="filteredCoffeeProducts.length > 0">
        <h2 class="category-title">Trà Sữa</h2>
      ...
      <div class="category-section" v-if="filteredDessertProducts.length > 0">
        <h2 class="category-title">Trà tươi</h2>
        <div class="products-grid">
...
export default {
  ...
  computed: {
    ...
    filteredCoffeeProducts() {
      return this.filteredProducts.filter(product => product.category === 'TraSua')
    },
    filteredDessertProducts() {
      return this.filteredProducts.filter(product => product.category === 'TraTuoi')
    },
